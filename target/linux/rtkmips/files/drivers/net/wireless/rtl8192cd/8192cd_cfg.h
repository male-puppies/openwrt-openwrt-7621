...
//#define SUPPORT_TX_AMSDU // 97F merge issue
...
#define PRIV_STA_BUF
#endif
#if defined(CONFIG_WLAN_HAL_8197F) && defined(CONFIG_RTL_8812_SUPPORT) && defined(CONFIG_RTL_NFJROM_MP)
#define PRIV_STA_BUF
#endif
//-------------------------------------------------------------
...
/*adjusted for support AMSDU*/
    ...
    #define MIN_RX_BUF_LEN  MAX_RX_BUF_LEN
                ...
                #define MAX_RX_BUF_LEN  4400//8800  
                #define MIN_RX_BUF_LEN  4400//8800 
                #else
