...
//	{Qc9KEepromTemplateVersion,offsetof(QC98XX_EEPROM,baseEepHeader.template_version),sizeof(A_UINT8),1,1,1,'u',1,-1,-1,0},
	...
	{Qc9KEepromRegulatoryDomain,offsetof(QC98XX_EEPROM,baseEepHeader.regDmn),sizeof(A_UINT16),2,1,1,'x',2,-1,-1,0},
    ...
    // biModalHeader
	//2G
	{Qc9KEeprom2GHzTxRxGainTx,offsetof(QC98XX_EEPROM,biModalHeader)+sizeof(BIMODAL_EEP_HEADER)+offsetof(BIMODAL_EEP_HEADER,txrxgain),sizeof(A_UINT8),1,1,1,'x',1,7,4,0},
	{Qc9KEeprom2GHzTxRxGainRx,offsetof(QC98XX_EEPROM,biModalHeader)+sizeof(BIMODAL_EEP_HEADER)+offsetof(BIMODAL_EEP_HEADER,txrxgain),sizeof(A_UINT8),1,1,1,'x',1,3,0,0},
    ...
    // 5G
	{Qc9KEeprom5GHzTxRxGainTx,offsetof(QC98XX_EEPROM,biModalHeader)+offsetof(BIMODAL_EEP_HEADER,txrxgain),sizeof(A_UINT8),1,1,1,'x',1,7,4,0},
	{Qc9KEeprom5GHzTxRxGainRx,offsetof(QC98XX_EEPROM,biModalHeader)+offsetof(BIMODAL_EEP_HEADER,txrxgain),sizeof(A_UINT8),1,1,1,'x',1,3,0,0},
	...
	{Qc9KEeprom2GHzCalibrationFrequency,offsetof(QC98XX_EEPROM,calFreqPier2G),sizeof(A_UINT8),WHAL_NUM_11G_CAL_PIERS,1,1,'2',1,-1,-1,0},
        ...
        {Qc9KEeprom2GHzCalibrationTemperature,offsetof(QC98XX_EEPROM,calPierData2G)+offsetof(CAL_DATA_PER_FREQ_OLPC,thermCalVal),sizeof(A_UINT8),WHAL_NUM_11G_CAL_PIERS,1,1,'u',22,-1,-1,0},
...
//	{Qc9KEeprom2GHzTargetPowerVht40,offsetof(QC98XX_EEPROM,targetPower2GVHT40),sizeof(A_UINT8),WHAL_NUM_11G_40_TARGET_POWER_CHANS,WHAL_NUM_11G_40_TARGET_POWER_RATES,1,'p',WHAL_NUM_11G_40_TARGET_POWER_CHANS*100+WHAL_NUM_11G_40_TARGET_POWER_RATES,-1,-1,0},
    ...
    {Qc9KEeprom5GHzCalibrationFrequency,offsetof(QC98XX_EEPROM,calFreqPier5G),sizeof(A_UINT8),WHAL_NUM_11A_CAL_PIERS,1,1,'5',1,-1,-1,0},
        ...
        {Qc9KEeprom5GHzCalibrationTemperature,offsetof(QC98XX_EEPROM,calPierData5G)+offsetof(CAL_DATA_PER_FREQ_OLPC,thermCalVal),sizeof(A_UINT8),WHAL_NUM_11A_CAL_PIERS,1,1,'u',22,-1,-1,0},
		...
		case 2:
			...
			for(it=0; it<length; it++)
			{
				...
				switch(type)
				{
                                                case 'p':
                                                        {
                                                                nc=SformatOutput(&buffer[lc],max-lc-1,"%.7lf",0.125*(voff+(int)(vuse&0xffff)));
                                                        }
                                                        break;
	...
	char type, QC98XX_EEPROM *mptr, int mcount, int all)
{
	...
	int mcs_1_2_11_12_21_22_offset=0;
	int mcs_1_2_11_12_21_22_low=0;
	int mcs_1_2_11_12_21_22_high=0;
	int mcs_1_2_11_12_21_22_extra=0;
	int mcs_3_4_13_14_23_24_offset=0;
	int mcs_3_4_13_14_23_24_low=0;
	int mcs_3_4_13_14_23_24_high=0;
	int mcs_3_4_13_14_23_24_extra=0;
